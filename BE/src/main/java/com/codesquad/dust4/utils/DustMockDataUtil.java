...
public class DustMockDataUtil {
  ...
  public static DustForecast createDumpDustForecastData() {
    ...
    images.add("http://www.airkorea.or.kr/file/viewImage/?atch_id=138845");
    images.add("http://www.airkorea.or.kr/file/viewImage/?atch_id=138846");
    images.add("http://www.airkorea.or.kr/file/viewImage/?atch_id=138847");
    MockData.setImages(images);
    return MockData;
  }
}
